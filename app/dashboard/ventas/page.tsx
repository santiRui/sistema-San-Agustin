...
export default function VentasHechasPage() {
  ...
  useEffect(() => {
    const fetchVentas = async () => {
      ...
      try {
        ...
        if (fromIso && toIso) q1 = q1.gte('created_at', fromIso).lt('created_at', toIso);
        const res1 = await q1;
        ...
        if (err1) {
          ...
          let q2 = supabase
            ...
            `)
            .order('created_at', { ascending: false });
          if (fromIso && toIso) q2 = q2.gte('created_at', fromIso).lt('created_at', toIso);
          const res2 = await q2;
          ...
          if (err2) {
            ...
            let q3 = supabase
              ...
              `)
              .order('created_at', { ascending: false });
            if (fromIso && toIso) q3 = q3.gte('created_at', fromIso).lt('created_at', toIso);
            const res3 = await q3;
    ...
    fetchVentas();
  }, [showAlert, datePreset, selectedDate]);
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      ...
      {/* Barra de filtros superior: rango de fechas + fecha específica + mes/año */}
